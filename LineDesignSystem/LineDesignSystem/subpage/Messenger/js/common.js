$(function(){
  ...
  $(window).ready(function(){
    $('.slide.load').css('transition', '1.7s').css('padding-top', '0').css('opacity', '1');
  })
  ...
  $(window).scroll(function(){
    ...
    $('.slide').each(function(){
      ...
      if (thisOffset.top - 650 <= scHeight && scHeight < thisOffset.top + wHeight ) {
        $(this).css('transition', '1.7s').css('padding-top', '0').css('opacity', '1');
      }
    });
  });
